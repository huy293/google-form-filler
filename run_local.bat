...
echo =========================================================
echo.
echo * Buoc 1: Dong bo code moi nhat tu GitHub...
git pull
echo.
echo * Buoc 2: Tu dong giai phong cong 8888 (tat cac server cu)...
for /f "tokens=5" %%a in ('netstat -aon ^| findstr :8888') do taskkill /f /pid %%a 2>nul
echo.
echo * Buoc 3: Kiem tra va tu dong cai dat Chrome ao neu thieu...
python -m playwright install chromium
echo.
echo * Buoc 4: Khoi chay Server...
